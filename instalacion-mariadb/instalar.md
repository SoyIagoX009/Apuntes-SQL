...
![Consola con el comando 'sudo apt-get update'](/master/instalacion-mariadb/attachments/1.png?raw=true)
...
![Consola con el comando 'sudo apt-get upgrade'](/master/instalacion-mariadb/attachments/2.png?raw=true)
...
![Consola con el comando 'sudo apt-get upgrade', solicitando permiso para actualizar](/master/instalacion-mariadb/attachments/3.png?raw=true)
...
![Consola con el comando 'sudo apt-get upgrade', en proceso de actualizar, solicitando permiso para reiniciar servicios](/master/instalacion-mariadb/attachments/4.png?raw=true)
...
![Consola con el comando 'sudo apt install mariadb-server'](/master/instalacion-mariadb/attachments/5.png?raw=true)
...
![Consola con el comando 'sudo apt install mariadb-server', solicitando permiso para continuar](/master/instalacion-mariadb/attachments/6.png?raw=true)
...
![Consola con el comando 'sudo /etc/init.d/mysql start'](/master/instalacion-mariadb/attachments/10.png?raw=true)
Ejecutaremos <sudo /etc/init.d/mysql start> para arrancar el servidor MariaDB que acabamos de configurar.

![Consola con el comando 'sudo mysql -u root -p'](/master/instalacion-mariadb/attachments/11.png?raw=true)
...
![Consola con la sentencia SQL 'CREATE USER 'iago' IDENTIFIED BY 'averysecurepswd', en el shell de MariaDB](/master/instalacion-mariadb/attachments/13.png?raw=true)
...
![Consola mostrando el shell de MariaDB, tras haber ejecutado 'mysql -p'](/master/instalacion-mariadb/attachments/20.png?raw=true)
